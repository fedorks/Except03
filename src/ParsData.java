...
public class ParsData {
    ...
    public HashMap<String, Object> parsInputData() {
        Except03.InputData inputData = new Except03.InputData();
        ...
        for (String i : data) {
            if (i.length() == 1) {
                if (i.equals("f") || i.equals("m")) {
                    ...
                    try {
                        throw new Except03.SexException();
                    } catch (Except03.SexException e) {
                        e.sexException(i);
                    }
                }
                ...
                if (Integer.parseInt(arrayDate[0]) < 0 ||
                    ...
                    try {
                        throw new Except03.DateException();
                    } catch (Except03.DateException e) {
                        e.dataException(i);
                    }
                } else {
